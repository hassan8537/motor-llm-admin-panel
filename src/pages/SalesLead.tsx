...
const SalesLead = () => {
    ...
    return (
      <div className="p-4 bg-gray-100 rounded-lg shadow-sm">
                    <h1 className="text-center fw-bold my-2">LeaderBoard</h1>

        <table className="w-full border-collapse">
          <thead>
            <tr className="border-b border-gray-800">
              <th className="py-3 font-medium text-black uppercase text-center tracking-wider">Rank</th>
              <th className="py-3 font-medium text-black uppercase text-center tracking-wider">Sales Person</th>
              <th className="py-3 font-medium text-black uppercase text-center tracking-wider">Total Sales MTD</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-800">
            {salesData.map((item) => {
              return (
                <tr key={item.rank} >
                  <td className="py-3 text-center">{item.rank}</td>
