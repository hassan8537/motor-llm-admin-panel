  ...
  return (
    <div className="max-w-xl p-4 bg-white shadow-lg">
      <div className="grid grid-cols-1 gap-4">
        <div className="flex">
          <div className="w-24 h-24 rounded-full bg-gray-200 flex items-center justify-center border border-gray-300"></div>
          <span className="text-gray-500 ms-3 text-sm items-center flex ">
            Upload picture
          </span>
        </div>
