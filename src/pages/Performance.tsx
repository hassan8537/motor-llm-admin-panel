      ...
      {dummyData.map(user => (
        ...
        >
          ...
          <p className="text-sm text-gray-700">
            ...
            <span
              className={
                user.activeOrders === 5 ? "text-green-500" : "text-red-500"
              }
            >
              {user.activeOrders}
            </span>
          ...
          <p className="text-sm text-gray-700 flex items-center gap-1">
            ...
            <span
              className={`w-3 h-3 rounded-full ${user.performanceColor}`}
            ></span>
          </p>
              ...
              <div className="bg-white p-6 rounded-lg w-full max-w-lg">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between">
                    <div>
                      ...
                      <div className="space-y-1 mt-2 text-sm">
                        ...
                        <p>
                          <span className="text-gray-600">Phone:</span> +1 123
                          456 7890
                        </p>
                        <p>
                          <span className="text-gray-600">Address:</span> S25 E
                          68th street
                        </p>
                        <p>
                          <span className="text-gray-600"></span> New York, NY
                          10651-78 156-187-60
                        </p>
                      </div>
                    </div>
                    <div className="space-y-1 mt-2 text-sm">
                      ...
                      <p>
                        <span className="text-gray-600">Performance:</span> 85%{" "}
                        <span className="text-green-500">●</span>
                      </p>
                      <p>
                        <span className="text-gray-600">Total Sales MTD:</span>{" "}
                        $88,000
                      </p>
                      <p>
                      ...
                      <p>
                        <span className="text-gray-600">Active Orders:</span> 5
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-1 mt-2 text-sm">
                      <p>
                        <span className="text-gray-600">Gender:</span> Male
                      </p>
                      <p>
                        <span className="text-gray-600">Date of Birth:</span> 20
                        July, 1992
                      </p>
                    </div>
                  </div>
