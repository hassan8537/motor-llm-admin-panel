        ...
        <div className="flex flex-row gap-6">
          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-2 gap-4 mb-3">
              <div>
                <p>
                  <strong>Account Manager:</strong> Brandon Gerak
                </p>
                <p>
                  <strong>SO #:</strong> S14267
                </p>
                <p>
                  <strong>Customer:</strong> Kebby Industries
                </p>
                <p>
                  <strong>Client PO:</strong> 600758
                </p>
                <p>
                  <strong>Part Number:</strong> HCP-250-SS
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1">
            <div className="mt-8">
              {" "}
              {/* Added margin to align with first column content */}
              <p>
                <strong>Quantity EA:</strong> 650
              </p>
              <p>
                <strong>Price EA $:</strong> $2.25
              </p>
              <p>
                <strong>Total Revenue:</strong> $1,462.50
              </p>
              <p>
                <strong>Due Date:</strong> 1/29/2025
              </p>
            </div>
          </div>
          ...
          <div className="flex-1">
            <p className="mb-2">
              <strong>Picture of the product (if any)</strong>
            </p>
