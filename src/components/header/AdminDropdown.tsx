  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="block mr-1 text-black text-lg">Hi, Alex!</span>
        <Link to="/profile">
        ...
        <span className="mr-3 ms-2 overflow-hidden h-11 w-11 cursor-pointer flex items-center justify-center ">
        <img src="/images/notification-iconn.png" alt="User" />
        </span>
        </Link>
      </button>
    </div>
