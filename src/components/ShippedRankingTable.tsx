      ...
      <table className="w-full border-collapse">
        ...
        <tr>
          ...
          <tr className="border-b border-gray-800">
            ...
            <th className="py-3 text-sm font-medium text-gray-500 uppercase text-center tracking-wider">MTD</th>
            <th className="py-3 text-sm font-medium text-gray-500 uppercase text-center tracking-wider">YTD</th>
          </tr>
        </thead>
